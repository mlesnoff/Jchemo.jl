...
For each spectra (row-observation of matrix `X`) and each defined gap, the correction is done by extrapolation 
from a simple linear regression computed on the left side of the gap. 
