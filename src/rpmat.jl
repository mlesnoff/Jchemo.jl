...
The function returns a random projection matrix V of dimension `p` x `nlv`. The projection of 
a given matrix X of size n x `p` is given by X * V.

V is simulated from i.i.d. N(0, 1) / sqrt(`nlv`).

## References 
Li, V., Hastie, T.J., Church, K.W., 2006. Very sparse random projections, in: Proceedings of 
...
The function returns a random projection matrix V of dimension `p` x `nlv`. The projection of a given matrix X 
...
## References 
Achlioptas, D., 2001. Database-friendly random projections, in: Proceedings of the Twentieth 
ACM SIGMOD-SIGACT-SIGART Symposium on Principles of Database Systems, PODS ’01. 
Association for Computing Machinery, New York, NY, USA, pp. 274–281. 
https://doi.org/10.1145/375551.375608

Li, V., Hastie, T.J., Church, K.W., 2006. Very sparse random projections, in: Proceedings of the 12th ACM 
SIGKDD International Conference on Knowledge Discovery and Data Mining, KDD ’06. Association 
