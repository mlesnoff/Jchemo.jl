"""
    calpds(; npoint::Signed = 5, algo::Function = plskern, kwargs...)
    calpds(X1, X2; npoint::Signed = 5, algo::Function = plskern, kwargs...)
...
```
""" 
function calpds(X1, X2; npoint::Signed = 5, algo::Function = plskern, kwargs...)
